...
export default function About() {
  return (
    <div>
      <Header />
      <section className="mt-1 max-sm:mt-6">
        <div className="p-5">
          <h1 className="text-center text-2xl uppercase font-semibold tracking-wider max-sm:text-xl max-sm:mb-10">
            About Me
          </h1>
          ...
          <div>
            ...
            <p>
              Developing projects and receiving feedback is something I
              absolutely love, as it greatly motivates me and inspires me to
